...
const Faq = () => {
    return (
        <div className='my-10'>
            <section className="bg-gradient-to-r from-blue-50 to-purple-100 dark:bg-teal-900 grid grid-cols-1 lg:grid-cols-2 items-center text-black text-left ">
                <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
                    ...
                    <div className="space-y-4">
                        <details className="w-full border border-gray-800 rounded-lg">
                            ...
                            <p className="px-4 py-6 pt-0 ml-4 -mt-4 text-gray-500 dark:text-gray-100">EasyLearn offers courses on various academic subjects, including Math, Science, English, and ICT, tailored for students from primary to higher secondary levels. </p>
                        </details>
                        <details className="w-full border border-gray-800 rounded-lg">
                            ...
                            <p className="px-4 py-6 pt-0 ml-4 -mt-4 text-gray-500 dark:text-gray-100">Once enrolled, you can access all course materials, video lectures, and practice quizzes directly through the EasyLearn platform or mobile app. </p>
                        </details>
                        <details className="w-full border border-gray-800 rounded-lg">
                            ...
                            <p className="px-4 py-6 pt-0 ml-4 -mt-4 text-gray-500 dark:text-gray-100">You can contact our support team through the “Help & Support” section on the EasyLearn website or app. You may also email us at support@easylearn.com for assistance. </p>
                        </details>
                    </div>
                </div>
